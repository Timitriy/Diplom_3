...
class ForgotPasswordLocators:
    ...
    # Поле ввода e-mail (понадобится в следующем тесте)
    EMAIL_INPUT = (By.CSS_SELECTOR, "input[name='name']")  # уточним позже, placeholder 'Укажите e-mail'
    ...
    TOGGLE_PASSWORD_VISIBILITY = (By.CSS_SELECTOR, "svg[type='password']")  # уточним после инспекции DOM шага 2